...
function Product({AddTocart, AddToList}) {
            ...
            <section className="w-full bg-[#f4f1ea] py-10 flex flex-col justify-center items-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 py-10 px-20 w-full  m-auto">
                    {filteritems.map((category, index) => (
                        <div
                            key={index}
                            className="p-4 rounded-lg shadow-md transition-transform transform hover:scale-105 cursor-pointer hover:bg-green-400 hover:text-white relative"
                        >
                            <div className="flex flex-col items-center text-center gap-5">
                                ...
                                <img
                                    src={category.image}
                                    alt={category.name}
                                    className="w-60 h-60 md:w-96 md:h-48 object-cover rounded-full mb-4"
                                />
